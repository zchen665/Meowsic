...
public final class Constants {
    ...
    public static final String ACTION_PAUSE = "AudioCaptureService:Pause";
    ...
    public static final String PREFERENCES_APP_NAME = "Meowsic";
    public static final String PREFERENCES_KEY_OUTPUT_DIRECTORY = "Meowsic";
